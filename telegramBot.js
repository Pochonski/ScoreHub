...
async function handleCommand(chatId, text, userName, userId) {
  ...
  switch (cmd) {
    ...
    default:
      // Comandos de equipo (/resultado /analizar /info /seguir /grupo /racha
      // /proximos /dondever /dejarseguir /misfavoritos + stat aliases):
      // migrados al router (Fase 7 — commands/teams.js).
